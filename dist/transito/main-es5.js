...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var keyframes = { bounce: bounce, swing: swing, scale: scale, translate: translate };
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EstadoUsuarioComponent = /** @class */ (function () {
                function EstadoUsuarioComponent(data, dialogRef) {
                    this.data = data;
                    this.dialogRef = dialogRef;
                    this.opcion = '';
                }
                EstadoUsuarioComponent.prototype.ngOnInit = function () {
                    this.data.usuario.active ? this.opcion = 'desactivar' : this.opcion = 'activar';
                };
                EstadoUsuarioComponent.prototype.cerrar = function (cambiar) {
                    this.dialogRef.close(cambiar);
                };
                return EstadoUsuarioComponent;
            }());
            EstadoUsuarioComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuardarGuiaComponent = /** @class */ (function (_super) {
                __extends(GuardarGuiaComponent, _super);
                function GuardarGuiaComponent(router, errorService, toast, activatedRoute, documentoService, guiasService, tiposService, puntosService) {
                    ...
                    _this.tiposService = tiposService;
                    _this.puntosService = puntosService;
                ...
                GuardarGuiaComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.guia$ = this.activatedRoute.params
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (params) { return params['nombreGuia']; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (nombre) { return _this.guiasService.buscarGuiaPorTitulo(nombre); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                    ...
                    this.puntosService.obtenerPuntosDeAtencion().subscribe(function (punto) { return _this.puntosDeAtencion ?
                        _this.puntosDeAtencion = _this.puntosDeAtencion.concat([{ punto: punto, checked: false }]) : _this.puntosDeAtencion = [{ punto: punto, checked: false }]; }, function (error) { return _this.handleException(error); });
                };
                GuardarGuiaComponent.prototype.addPaso = function (guia) {
                    if (guia.pasos) {
                ...
                GuardarGuiaComponent.prototype.uploadFile = function (paso, event) {
                    var _this = this;
                ...
                GuardarGuiaComponent.prototype.deleteAttachment = function (paso, index) {
                    paso.anexos.splice(index, 1);
                };
                GuardarGuiaComponent.prototype.uploadFileGuia = function (event, guia) {
                    var _this = this;
                    this.showSpinner = true;
                    for (var index = 0; index < event.length; index++) {
                        var element = event[index];
                ...
                GuardarGuiaComponent.prototype.deleteAttachmentGuia = function (index, guia) {
                    guia.formularios.splice(index, 1);
                };
                GuardarGuiaComponent.prototype.obtenerArchivosEnPaso = function (paso) {
                    return paso.anexos;
                };
                GuardarGuiaComponent.prototype.guardarGuia = function (guia) {
                    var _this = this;
                    this.showSpinner = true;
                    this.puntosDeAtencion.forEach(function (puntoDeAtencion) {
                        if (guia.puntosDeAtencion)
                            guia.puntosDeAtencion.concat([puntoDeAtencion.punto]);
                        else
                            guia.puntosDeAtencion = guia.puntosDeAtencion = [puntoDeAtencion.punto];
                    });
                    var guiaAGuardar = new src_app_models_GuiaDeTramite__WEBPACK_IMPORTED_MODULE_6__["GuiaDeTramite"](guia.id ? guia.id : '', guia.titulo ? guia.titulo : '', guia.descripcion ? guia.descripcion : '', guia.formularios ? guia.formularios : [], guia.pasos ? guia.pasos : [], this.categoria, guia.soporteLegal ? guia.soporteLegal : '', guia.puntosDeAtencion ? guia.puntosDeAtencion : []);
                    this.guiasService.guardarGuia(guiaAGuardar)
                        .subscribe(function () {
                        _this.showSpinner = false;
                        _this.toast.success('Se guardo la guia correctamente');
                    }, function (error) {
                        _this.showSpinner = false;
                        _this.handleException(error);
                    });
                };
                GuardarGuiaComponent.prototype.obtenerArchivosEnGuia = function (guia) {
                    return guia.formularios;
                };
                GuardarGuiaComponent.prototype.actualizarDescripcion = function (_a, guia) {
                    var editor = _a.editor;
                    var data = editor.getData();
                    guia.descripcion = data;
                };
                GuardarGuiaComponent.prototype.actualizarDescripcionEnPaso = function (_a, paso) {
                    var editor = _a.editor;
                    var data = editor.getData();
                    paso.descripcion = data;
                };
                GuardarGuiaComponent.prototype.doAction = function (action, guia) {
                    action === 'guardarGuia' ? this.guardarGuia(guia) : this.addPaso(guia);
                };
                GuardarGuiaComponent.prototype.cargarMultimedia = function (documento) {
                    return "http://" + documento.rutaDeDescarga;
                };
                return GuardarGuiaComponent;
            }(src_app_pages_base_base_component__WEBPACK_IMPORTED_MODULE_7__["BaseComponent"]));
            GuardarGuiaComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuiaCardComponent = /** @class */ (function () {
                function GuiaCardComponent(sanitizer) {
                ...
                GuiaCardComponent.prototype.actualizarGuia = function (guia) {
                    this.actualizaGuia.emit(guia);
                };
                GuiaCardComponent.prototype.descripcionComoHTML = function (descripcion) {
                    return this.sanitizer.bypassSecurityTrustHtml(descripcion);
                };
                GuiaCardComponent.prototype.eliminarGuia = function (guia) {
                    this.eliminaGuia.emit(guia);
                };
                return GuiaCardComponent;
            }());
            GuiaCardComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PuntoAtencionComponent = /** @class */ (function (_super) {
                __extends(PuntoAtencionComponent, _super);
                function PuntoAtencionComponent(router, errorService, toast, puntoDeAtencionService) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.toast = toast;
                    _this.puntoDeAtencionService = puntoDeAtencionService;
                    _this.puntosDeAtencion = [];
                    _this.nombre = '';
                    _this.guardarPuntos = function () {
                        _this.puntoDeAtencionService
                            .guardarPuntoDeAtencion(_this.puntosDeAtencion
                            .map(function (puntoEnElMapa) { return puntoEnElMapa.punto; }))
                            .subscribe(function () { return _this.toast.success('Puntos de atención guardados'); }, function (error) { return _this.handleException(error); });
                    };
                ...
                PuntoAtencionComponent.prototype.ngAfterViewInit = function () {
                    var _this = this;
                    ...
                    this.map.addEventListener('tap', function (evt) {
                        _this.añadirMarcador(evt, ui);
                    });
                    this.puntoDeAtencionService.obtenerPuntosDeAtencion()
                        .subscribe(function (punto) {
                        var marker = _this.construirMarcador(punto.latitud, punto.longitud);
                        _this.map.addObject(marker);
                        _this.puntosDeAtencion = _this.puntosDeAtencion.concat([{ marker: marker, punto: punto }]);
                    });
                };
                PuntoAtencionComponent.prototype.construirMarcador = function (latitud, longitud) {
                    return new H.map.Marker({
                        lat: latitud,
                        lng: longitud
                    });
                };
                PuntoAtencionComponent.prototype.añadirMarcador = function (evt, ui) {
                    if (this.nombre && this.nombre !== '') {
                        var coord = this.map.screenToGeo(evt.currentPointer.viewportX, evt.currentPointer.viewportY);
                        var latitud = coord.lat.toFixed(4);
                        var longitud = coord.lng.toFixed(4);
                        var marker = this.construirMarcador(latitud, longitud);
                        this.map.addObject(marker);
                        var punto = new src_app_models_PuntoAtencion__WEBPACK_IMPORTED_MODULE_2__["PuntoAtencion"]('', this.nombre, latitud, longitud);
                        this.puntosDeAtencion = this.puntosDeAtencion.concat([{ marker: marker, punto: punto }]);
                    }
                    // const informacion = this.construirformacionDelMarcador(latitud, longitud);
                    // ui.addBubble(informacion);
                };
                PuntoAtencionComponent.prototype.construirformacionDelMarcador = function (latitud, longitud) {
                    return new H.ui.InfoBubble({ lat: latitud, lng: longitud }, {
                        content: '<b>Hello World!</b>'
                    });
                };
                PuntoAtencionComponent.prototype.eliminarMarcador = function (punto) {
                    this.puntosDeAtencion = this.puntosDeAtencion.filter(function (puntoAtencion) { return puntoAtencion !== punto; });
                    this.map.removeObject(punto.marker);
                };
                return PuntoAtencionComponent;
            }(src_app_pages_base_base_component__WEBPACK_IMPORTED_MODULE_4__["BaseComponent"]));
            PuntoAtencionComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SpeedDialFloatingButtonComponent = /** @class */ (function () {
                function SpeedDialFloatingButtonComponent() {
                    this.actionBtn = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                    this.buttons = [];
                    this.fabTogglerState = 'inactive';
                }
                SpeedDialFloatingButtonComponent.prototype.showItems = function () {
                    this.fabTogglerState = 'active';
                    this.buttons = this.fabButtons;
                };
                SpeedDialFloatingButtonComponent.prototype.hideItems = function () {
                    this.fabTogglerState = 'inactive';
                    this.buttons = [];
                };
                SpeedDialFloatingButtonComponent.prototype.onToggleFab = function () {
                    this.buttons.length ? this.hideItems() : this.showItems();
                };
                SpeedDialFloatingButtonComponent.prototype.onAction = function (action) {
                    this.actionBtn.emit(action);
                };
                return SpeedDialFloatingButtonComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableComponent = /** @class */ (function () {
                ...
                TableComponent.prototype.getValueAtIndex = function (entity, index) {
                    return entity[Object.keys(entity)[index]];
                };
                TableComponent.prototype.getColumnsTodisplay = function () {
                    if (this.hasActions && !this.conlumnsToDisplay.some(function (x) { return x === 'Actions'; })) {
                        this.conlumnsToDisplay.push('Actions');
                    }
                    return this.conlumnsToDisplay;
                };
                TableComponent.prototype.propertiesElement = function (row) {
                    this.properties.emit(row);
                };
                TableComponent.prototype.updateElement = function (row) {
                    this.update.emit(row);
                };
                TableComponent.prototype.deleteElement = function (row) {
                    this.delete.emit(row);
                };
                TableComponent.prototype.showActions = function (column) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Documento = /** @class */ (function () {
                function Documento(id, nombre, archivo, fechaCreacion, fechaActualizacion, rutaDeDescarga, extension) {
                    this.id = id;
                    this.nombre = nombre;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var GuiaDeTramite = /** @class */ (function () {
                function GuiaDeTramite(id, titulo, descripcion, formularios, pasos, tipo, soporteLegal, puntosDeAtencion) {
                    this.id = id;
                    this.titulo = titulo;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var Paso = /** @class */ (function () {
                function Paso(titulo, descripcion, anexos) {
                    this.titulo = titulo;
                    this.descripcion = descripcion;
                    this.anexos = anexos;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var PuntoAtencion = /** @class */ (function () {
                function PuntoAtencion(id, nombre, latitud, longitud) {
                    this.id = id;
                    this.nombre = nombre;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var User = /** @class */ (function () {
                function User(id, nombreDeUsuario, correoElectronico, password, numeroDeTelefono, active, role) {
                    this.id = id;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaseComponent = /** @class */ (function () {
                ...
                BaseComponent.prototype.openPage = function (routename) {
                ...
                BaseComponent.prototype.mostrarOpcionesSuperAdmin = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardComponent = /** @class */ (function (_super) {
                ...
                function DashboardComponent(router, errorService, toast) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.toast = toast;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DocumentosComponent = /** @class */ (function (_super) {
                __extends(DocumentosComponent, _super);
                function DocumentosComponent(router, errorService, toast, documentosService) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.toast = toast;
                    _this.documentosService = documentosService;
                    _this.columnas = ['nombre', 'fecha de creacion', 'fecha de actualizacion'];
                    return _this;
                }
                DocumentosComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.documentos$ = this.documentosService
                        .buscarDocumentos().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["catchError"])(function (error) {
                        _this.handleException(error);
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])();
                    }));
                };
                DocumentosComponent.prototype.obtenerDatosTablaDocumentos = function (documentos) {
                    return documentos.map(function (documento) {
                        var nombre = documento.nombre, fechaCreacion = documento.fechaCreacion, fechaActualizacion = documento.fechaActualizacion;
                        return { nombre: nombre, fechaCreacion: fechaCreacion, fechaActualizacion: fechaActualizacion };
                    });
                };
                DocumentosComponent.prototype.actualizarDocumento = function () {
                };
                DocumentosComponent.prototype.eliminarDocumento = function (index) {
                    var _this = this;
                    this.documentos$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["filter"])(function (documento, i) { return i === index; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(function (documento) { return _this.documentosService.eliminarDocumento(documento); })).subscribe(function () { return _this.toast.success('Documento eliminado satisfactoriamente'); }, function (error) { return _this.handleException(error); });
                };
                return DocumentosComponent;
            }(_base_base_component__WEBPACK_IMPORTED_MODULE_3__["BaseComponent"]));
            DocumentosComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuiaDetallesComponent = /** @class */ (function (_super) {
                __extends(GuiaDetallesComponent, _super);
                function GuiaDetallesComponent(router, errorService, toast, guiasService, documentosService, activatedRoute, sanitizer) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.toast = toast;
                ...
                GuiaDetallesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.guia$ = this.activatedRoute.params
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])(function (params) { return params['nombreGuia']; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["switchMap"])(function (nombre) { return _this.guiasService.buscarGuiaPorTitulo(nombre); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["tap"])(function (guia) { return _this.obtenerMultimedia(guia.formularios); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["catchError"])(function (error) {
                        _this.handleException(error);
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["of"])();
                    }));
                };
                GuiaDetallesComponent.prototype.ngAfterViewInit = function () {
                    var defaultLayers = this.platform.createDefaultLayers();
                    this.map = new H.Map(this.mapElement.nativeElement, defaultLayers.vector.normal.map, {
                        zoom: 14,
                        center: { lat: 10.406887, lng: -75.516103 }
                ...
                return GuiaDetallesComponent;
            }(_base_base_component__WEBPACK_IMPORTED_MODULE_5__["BaseComponent"]));
            GuiaDetallesComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: src_app_errors_services_error_service__WEBPACK_IMPORTED_MODULE_3__["ErrorService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var GuiasdetramiteComponent = /** @class */ (function (_super) {
                __extends(GuiasdetramiteComponent, _super);
                function GuiasdetramiteComponent(router, errorService, toast, guiasService) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.toast = toast;
                ...
                GuiasdetramiteComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.guias$ = this.guiasService.buscarGuias()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["catchError"])(function (error) {
                        _this.handleException(error);
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])();
                    }));
                };
                GuiasdetramiteComponent.prototype.crearGuia = function () {
                    this.openPage('dashboard/guardar-nueva-guia');
                };
                GuiasdetramiteComponent.prototype.actualizarGuia = function (guia) {
                    this.openPage("dashboard/guardar-nueva-guia/" + guia.titulo);
                };
                GuiasdetramiteComponent.prototype.eliminarGuia = function (guiaAEliminar) {
                    var _this = this;
                    this.guiasService.eliminarGuia(guiaAEliminar)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["switchMap"])(function () { return _this.guias$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["filter"])(function (guia) { return guiaAEliminar.id === guia.id; })); })).subscribe(function () {
                        _this.toast.success('Guia eliminada correctamente');
                    }, function (error) { return _this.errorService.handleException(error); });
                };
                GuiasdetramiteComponent.prototype.mostrarGuia = function (guia) {
                    this.openPage("dashboard/guias/" + guia.titulo);
                };
                return GuiasdetramiteComponent;
            }(_base_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"]));
            GuiasdetramiteComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
                { type: src_app_errors_services_error_service__WEBPACK_IMPORTED_MODULE_5__["ErrorService"] },
                { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_6__["ToastrService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function (_super) {
                ...
                function LoginComponent(router, errorService, loginService, toast) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PreferenciasComponent = /** @class */ (function (_super) {
                __extends(PreferenciasComponent, _super);
                function PreferenciasComponent(router, errorService, toast, tiposService, documentosService) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.toast = toast;
                    _this.tiposService = tiposService;
                    _this.documentosService = documentosService;
                    _this.colorPrimario = 'azul';
                    _this.colorPrimarioToggle = false;
                    _this.colorSecundario = 'verde';
                    _this.colorSecundarioToggle = false;
                    _this.animation = '';
                    _this.tiempoAnimacion = 1000;
                    _this.iconoUrl = '../../../assets/img/DATT.png';
                    _this.tiempoEspera = 0;
                    _this.animacionesDisponibles = Object.keys(_animations_keyframes__WEBPACK_IMPORTED_MODULE_3__["keyframes"]);
                    _this.nombre = '';
                    _this.cambiarAvatar = function (file) {
                        var reader = new FileReader();
                        reader.onload = function (event) {
                            _this.iconoUrl = event.target.result;
                        };
                        _this.icono = file[0];
                        reader.readAsDataURL(_this.icono);
                    };
                    _this.guardarTipo = function () {
                        if (_this.icono && _this.nombre) {
                            _this.documentosService.guardarDocumento(_this.icono)
                                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["switchMap"])(function (documento) {
                                return _this.tiposService.guardarTipo(new src_app_models_Tipo__WEBPACK_IMPORTED_MODULE_8__["Tipo"]('', _this.nombre, documento));
                            })).subscribe(function (tipo) {
                                _this.toast.success('nueva categoria guardada con exito');
                                _this.tipos = _this.tipos.concat([tipo]);
                            }, function (error) { return _this.handleException(error); });
                        }
                        else {
                            _this.toast.error('debes añadir todos los datos');
                        }
                    };
                    _this.cargarMultimedia = function (documento) {
                        return documento.rutaDeDescarga;
                    };
                    return _this;
                }
                PreferenciasComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.tiposService.buscarTipos().subscribe(function (tipos) {
                        _this.tipos = tipos;
                    }, function (error) { return _this.handleException(error); });
                };
                return PreferenciasComponent;
            }(_base_base_component__WEBPACK_IMPORTED_MODULE_4__["BaseComponent"]));
            PreferenciasComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
                { type: src_app_errors_services_error_service__WEBPACK_IMPORTED_MODULE_6__["ErrorService"] },
                { type: ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function (_super) {
                ...
                function RegisterComponent(router, errorService, loginService, toast) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.loginService = loginService;
                    ...
                    if (this.username && this.password && this.email && this.phoneNumber) {
                        if (this.confirmPassword === this.password) {
                            ...
                            this.loginService.register(this.username, this.email, this.password, this.phoneNumber)
                                .subscribe(function () {
                                _this.showSpinner = false;
                                _this.toast.success('usuario creado exitosamente');
                            }, function (error) {
                                _this.handleException(error);
                                _this.showSpinner = false;
                            });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsuariosComponent = /** @class */ (function (_super) {
                ...
                function UsuariosComponent(router, errorService, toast, usuariosService, dialog) {
                    var _this = _super.call(this, router, errorService, toast) || this;
                    _this.router = router;
                    _this.errorService = errorService;
                    _this.toast = toast;
                    ...
                    _this.dialog = dialog;
                    _this.usuariosTbDatasource = [];
                    _this.usuarios = [];
                    _this.showSpinner = false;
                    _this.columnas = ['nombre', 'correo electronico', 'numero de contacto', "rol", "activo"];
                    return _this;
                }
                UsuariosComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.showSpinner = true;
                    this.usuariosService.buscarUsuarios().subscribe(function (usuarios) {
                        _this.usuarios = usuarios;
                        usuarios.forEach(function (usuario) {
                            _this.showSpinner = false;
                            var nombre = usuario.nombreDeUsuario;
                            var correoElectronico = usuario.correoElectronico;
                            var activo = usuario.active ? 'Activo' : 'Inactivo';
                            var numero = usuario.numeroDeTelefono;
                            var rol = usuario.role;
                            _this.usuariosTbDatasource.push({ nombre: nombre, correoElectronico: correoElectronico, numero: numero, rol: rol, activo: activo });
                        });
                    }, function (error) {
                        _this.handleException(error);
                        _this.showSpinner = false;
                ...
                UsuariosComponent.prototype.abrirEditarDialogo = function (index) {
                    var _this = this;
                    var dialogRef = this.dialog.open(src_app_components_estado_usuario_estado_usuario_component__WEBPACK_IMPORTED_MODULE_9__["EstadoUsuarioComponent"], {
                        data: { 'usuario': this.usuarios[index] }
                    });
                    dialogRef.afterClosed().subscribe(function (usuario) {
                        if (usuario) {
                            _this.showSpinner = true;
                            _this.usuariosService.modificarUsuario(new src_app_models_User__WEBPACK_IMPORTED_MODULE_6__["User"](usuario.id, usuario.nombreDeUsuario, usuario.correoElectronico, usuario.password, usuario.numeroDeTelefono, !usuario.active, usuario.role))
                                .subscribe(function () {
                                _this.showSpinner = false;
                                _this.usuarios[index].active = !_this.usuarios[index].active;
                                _this.toast.success('Usuario activado exitosamente');
                            }, function (error) {
                                _this.handleException(error);
                                _this.showSpinner = false;
                            });
                ...
                UsuariosComponent.prototype.eliminarUsuario = function (index) {
                    var _this = this;
                    this.showSpinner = true;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GuiasService = /** @class */ (function () {
                ...
                GuiasService.prototype.guardarGuia = function (guia) {
                    return this.http.post(this.url, guia);
                };
                GuiasService.prototype.buscarGuias = function () {
                    return this.http.get(this.url);
                };
                GuiasService.prototype.buscarGuiaPorTitulo = function (titulo) {
                    return this.http.getResource(this.url + "/titulo", titulo)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatAll"])());
                };
                GuiasService.prototype.eliminarGuia = function (guia) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm2015/operators/index.js");
            var PuntoAtencionService = /** @class */ (function () {
                function PuntoAtencionService(http) {
                    this.http = http;
                    this.url = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl + '/puntoDeAtencion';
                }
                PuntoAtencionService.prototype.obtenerPuntosDeAtencion = function () {
                    return this.http.get(this.url)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatAll"])());
                };
                PuntoAtencionService.prototype.guardarPuntoDeAtencion = function (puntosDeAtencion) {
                    return this.http.post(this.url, puntosDeAtencion);
                };
                PuntoAtencionService.prototype.eliminarPuntoAtencion = function (puntoDeAtencion) {
                    return this.http.delete(this.url, puntoDeAtencion);
                };
                return PuntoAtencionService;
            }());
            PuntoAtencionService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TiposService = /** @class */ (function () {
                function TiposService(http) {
                    ...
                    this.guardarTipo = function (tipo) {
                        return _this.http.post(_this.url, tipo);
                    };
                }
                return TiposService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginService = /** @class */ (function () {
                ...
                LoginService.prototype.login = function (username, password) {
                    var loginParam = { 'nombreUsuario': username, 'password': password, 'active': true };
                ...
                LoginService.prototype.register = function (username, email, password, phoneNumber) {
                    var user = new src_app_models_User__WEBPACK_IMPORTED_MODULE_5__["User"](null, username, email, password, phoneNumber, false, "ADMIN");
                    return this.http.post(this.url, user);
                };
                LoginService.prototype.buscarUsuarios = function () {
                    return this.http.get(this.url);
                };
                LoginService.prototype.modificarUsuario = function (usuario) {
                    return this.http.put(this.url, usuario);
                };
                LoginService.prototype.eliminarUsuario = function (usuario) {
